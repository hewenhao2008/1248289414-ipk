--[[
--N2N VPN(V2) configuration page. Made by 981213 就是蝈蝈→_→
--
]]--
...
ifmac = s:option(Flag, "ifmac", translate("Enable Custom mac"))
ifmac.rmempty = false

mac = s:option(Value, "mac", translate("Custom mac"))
mac.optional = false

mtu = s:option(Value, "mtu", translate("mtu"))
mtu.datatype = "range(0,1500)"
mtu.optional = false
